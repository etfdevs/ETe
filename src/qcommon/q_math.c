...
const vec4_t g_color_table[32] =
{
	...
	{ 0.0,  0.5f,    0.5f,    1.0 },      // B - md.cyan		18
	{ 0.5,  0.0,    0.5f,    1.0 },      // C - md.purple	19
	{ 0.0,  0.5f,    1.0,    1.0 },      // D				20
	{ 0.5f,  0.0,    1.0,    1.0 },      // E				21
	...
	{ 1.0,  1.0,    0.75f,   1.0 },      // N				30
	{ 1.0,  1.0,    0.5f,    1.0 },      // O				31
};


int ColorIndexFromChar( char ccode )
{
	return ColorIndex( ccode );
	/*if ( ccode >= '0' && ccode <= '9' ) {
		return ( ccode - '0' );
	}

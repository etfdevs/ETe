...
7z a "%APPVEYOR_BUILD_FOLDER%/ETe-Win32-%APPVEYOR_REPO_TAG_NAME%.7z" ETe.exe
cd %APPVEYOR_BUILD_FOLDER%/src/ded/%BUILD_CONFIGURATION%
7z a "%APPVEYOR_BUILD_FOLDER%/ETe-Win32-%APPVEYOR_REPO_TAG_NAME%.7z" ETe-ded.exe
cd %APPVEYOR_BUILD_FOLDER%
7z a "ETe-Win32-%APPVEYOR_REPO_TAG_NAME%.7z" docs\*
